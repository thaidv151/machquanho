  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl max-w-2xl w-full p-6 sm:p-8 relative max-h-[90vh] overflow-y-auto space-y-6 animate-scaleUp border border-[#E8DFC8]">
        ...
        {/* Description & Rich Text Content Body */}
        <div className="space-y-4 text-sm text-[#4A3B32] leading-relaxed">
          {topic.description && (
            <p className="text-base text-[#2D241E] font-medium leading-relaxed">{topic.description}</p>
          )}

          {topic.content && (
            <div 
              className="prose prose-sm max-w-none text-[#2D241E] leading-relaxed pt-2 border-t border-[#E8DFC8]/60 space-y-3"
